...
public class BuyerTransaction extends Transaction {
    ...
    public BuyerTransaction(String GSTNumber, Date transactionDate, String billNo, Integer GSTRate, BigDecimal taxableValue, BigDecimal IGST, BigDecimal CGST, BigDecimal SGST, BigDecimal total) {
